...
<Steps>
  ...
  <Step title="Add Cron Job">
    ...
    <Frame>
      <img src="/images/configuration/cronjob/service_creation.png" alt="Create Cron Job Service" />
    </Frame>
  </Step>
  ...
  <Step title="Deploy">
    ...
    <Frame>
      <img src="/images/configuration/cronjob/cronjob_recap.png" alt="Cron Job Configuration Recap" />
    </Frame>
  </Step>
</Steps>
...
<Steps>
  ...
  <Step title="Add Variable">
    ...
    <Frame>
      <img src="/images/configuration/cronjob/variables.png" alt="Cron Job Environment Variables" />
    </Frame>
  </Step>
...
<Frame>
  <img src="/images/configuration/cronjob/settings.png" alt="Cron Job Settings" />
</Frame>
...
<Frame>
  <img src="/images/configuration/cronjob/app-1.png" alt="Cron Job Actions" />
</Frame>
...
<Steps>
  ...
  <Step title="Clone Job">
    ...
    <Frame>
      <img src="/images/configuration/cronjob/clone_service.png" alt="Clone Cron Job" />
    </Frame>
  </Step>
...
<CardGroup cols={2}>
  ...
  <Card title="Deployment Logs" icon="file-lines" href="/deployment/logs">
    Monitor and troubleshoot job executions
  </Card>
  <Card title="Container Registry" icon="box" href="/integration/container-registry">
