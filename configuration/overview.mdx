...
<CardGroup cols={2}>
  <Card title="Clusters" icon="server" href="/configuration/clusters">
  ...
  <Card title="Scaleway Kapsule" icon="/images/logos/cloud-providers/scaleway-icon-light.svg" href="/integrations/kubernetes/scaleway/overview">
    Scaleway Kubernetes Kapsule setup
  </Card>

  <Card title="Bring Your Own Kubernetes" icon="cube" href="/integrations/kubernetes/byok">
