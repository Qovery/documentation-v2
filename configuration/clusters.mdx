...
| Icon | Provider |
|------|----------|
| ![AWS](/img/advanced_settings/aws.svg) | Amazon Web Services |
| ![GCP](/img/advanced_settings/gcp.svg) | Google Cloud Platform |
| ![Azure](/img/advanced_settings/azure.svg) | Microsoft Azure |
| ![Scaleway](/img/advanced_settings/scaleway.svg) | Scaleway |
...
- **Default**: `90` days
- **Type**: Integer
- **Cloud Provider**: ![AWS](/img/advanced_settings/aws.svg) AWS
...
- **Type**: Integer
- **Cloud Providers**: ![AWS](/img/advanced_settings/aws.svg) ![GCP](/img/advanced_settings/gcp.svg) ![Azure](/img/advanced_settings/azure.svg) ![Scaleway](/img/advanced_settings/scaleway.svg) All
...
- **Default**: `false`
- **Type**: Boolean
- **Cloud Provider**: ![GCP](/img/advanced_settings/gcp.svg) GCP
...
- **Default**: `null`
- **Type**: String
- **Cloud Providers**: ![AWS](/img/advanced_settings/aws.svg) ![Scaleway](/img/advanced_settings/scaleway.svg) ![Azure](/img/advanced_settings/azure.svg) AWS, Scaleway, Azure
...
- **Default**: `"lb-s"`
- **Type**: String
- **Cloud Provider**: ![Scaleway](/img/advanced_settings/scaleway.svg) Scaleway
- **Values**:
  - `"lb-s"`: 200 Mbps
  - `"lb-gp-m"`: 500 Mbps
  - `"lb-gp-l"`: 1 Gbps
...
**Database Icons**:
- ![Database Container](/img/advanced_settings/database-container.svg) Container Database
- ![Database Managed](/img/advanced_settings/database-managed.svg) Managed Database
...
Enable logging for cluster buckets into `<bucket>-log` bucket.

- **Default**: `false`
- **Type**: Boolean
- **Cloud Providers**: ![AWS](/img/advanced_settings/aws.svg) ![GCP](/img/advanced_settings/gcp.svg) ![Azure](/img/advanced_settings/azure.svg) AWS, GCP, Azure
...
- **Default**: `false`
- **Type**: Boolean
- **Cloud Providers**: ![AWS](/img/advanced_settings/aws.svg) ![GCP](/img/advanced_settings/gcp.svg) AWS, GCP
