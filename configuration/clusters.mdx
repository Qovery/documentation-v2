...
<AccordionGroup>
  ...
  <Accordion title="DNS Settings (1 setting)">
    | Setting | Default | Providers | Description |
    |---------|---------|-----------|-------------|
    | `dns.coredns.extra_config` | null | <img src="/images/logos/cloud-providers/aws-icon-light.svg" alt="AWS" class="badge-icon-aws-light" /><img src="/images/logos/cloud-providers/aws-icon-dark.svg" alt="AWS" class="badge-icon-aws-dark" /> <img src="/images/logos/cloud-providers/azure-icon.svg" alt="Azure" class="badge-icon" /> <img src="/images/logos/cloud-providers/scaleway-icon-light.svg" alt="Scaleway" class="badge-icon" /> | Custom CoreDNS configuration |
  </Accordion>
  ...
  <Accordion title="Image Registry (3 settings)">
    ...
    | `cloud_provider.container_registry.tags` | - | <img src="/images/logos/cloud-providers/aws-icon-light.svg" alt="AWS" class="badge-icon-aws-light" /><img src="/images/logos/cloud-providers/aws-icon-dark.svg" alt="AWS" class="badge-icon-aws-dark" /> <img src="/images/logos/cloud-providers/gcp-icon-new.svg" alt="GCP" class="badge-icon" /> <img src="/images/logos/cloud-providers/azure-icon.svg" alt="Azure" class="badge-icon" /> <img src="/images/logos/cloud-providers/scaleway-icon-light.svg" alt="Scaleway" class="badge-icon" /> | Registry custom tags |
  </Accordion>

  <Accordion title="Load Balancer (6 settings)">
    | Setting | Default | Providers | Description |
    |---------|---------|-----------|-------------|
    | `load_balancer.size` | lb-s | <img src="/images/logos/cloud-providers/scaleway-icon-light.svg" alt="Scaleway" class="badge-icon" /> | Load balancer size |
  ...
  <Accordion title="Nginx Controller Resources (4 settings)">
    | Setting | Default | Providers | Description |
    |---------|---------|-----------|-------------|
    | `nginx.vcpu.request_in_milli_cpu` | 200 | <img src="/images/logos/cloud-providers/aws-icon-light.svg" alt="AWS" class="badge-icon-aws-light" /><img src="/images/logos/cloud-providers/aws-icon-dark.svg" alt="AWS" class="badge-icon-aws-dark" /> <img src="/images/logos/cloud-providers/gcp-icon-new.svg" alt="GCP" class="badge-icon" /> <img src="/images/logos/cloud-providers/azure-icon.svg" alt="Azure" class="badge-icon" /> <img src="/images/logos/cloud-providers/scaleway-icon-light.svg" alt="Scaleway" class="badge-icon" /> | Nginx CPU request |
    | `nginx.vcpu.limit_in_milli_cpu` | 700 | <img src="/images/logos/cloud-providers/aws-icon-light.svg" alt="AWS" class="badge-icon-aws-light" /><img src="/images/logos/cloud-providers/aws-icon-dark.svg" alt="AWS" class="badge-icon-aws-dark" /> <img src="/images/logos/cloud-providers/gcp-icon-new.svg" alt="GCP" class="badge-icon" /> <img src="/images/logos/cloud-providers/azure-icon.svg" alt="Azure" class="badge-icon" /> <img src="/images/logos/cloud-providers/scaleway-icon-light.svg" alt="Scaleway" class="badge-icon" /> | Nginx CPU limit |
    | `nginx.memory.request_in_mib` | 768 | <img src="/images/logos/cloud-providers/aws-icon-light.svg" alt="AWS" class="badge-icon-aws-light" /><img src="/images/logos/cloud-providers/aws-icon-dark.svg" alt="AWS" class="badge-icon-aws-dark" /> <img src="/images/logos/cloud-providers/gcp-icon-new.svg" alt="GCP" class="badge-icon" /> <img src="/images/logos/cloud-providers/azure-icon.svg" alt="Azure" class="badge-icon" /> <img src="/images/logos/cloud-providers/scaleway-icon-light.svg" alt="Scaleway" class="badge-icon" /> | Nginx memory request |
  ...
  <Accordion title="Nginx HPA (3 settings)">
    | Setting | Default | Providers | Description |
    |---------|---------|-----------|-------------|
    | `nginx.hpa.cpu_utilization_percentage_threshold` | 50 | <img src="/images/logos/cloud-providers/aws-icon-light.svg" alt="AWS" class="badge-icon-aws-light" /><img src="/images/logos/cloud-providers/aws-icon-dark.svg" alt="AWS" class="badge-icon-aws-dark" /> <img src="/images/logos/cloud-providers/gcp-icon-new.svg" alt="GCP" class="badge-icon" /> <img src="/images/logos/cloud-providers/azure-icon.svg" alt="Azure" class="badge-icon" /> <img src="/images/logos/cloud-providers/scaleway-icon-light.svg" alt="Scaleway" class="badge-icon" /> | HPA CPU threshold (%) |
    | `nginx.hpa.min_number_instances` | 2 | <img src="/images/logos/cloud-providers/aws-icon-light.svg" alt="AWS" class="badge-icon-aws-light" /><img src="/images/logos/cloud-providers/aws-icon-dark.svg" alt="AWS" class="badge-icon-aws-dark" /> <img src="/images/logos/cloud-providers/gcp-icon-new.svg" alt="GCP" class="badge-icon" /> <img src="/images/logos/cloud-providers/azure-icon.svg" alt="Azure" class="badge-icon" /> <img src="/images/logos/cloud-providers/scaleway-icon-light.svg" alt="Scaleway" class="badge-icon" /> | Min Nginx instances |
    | `nginx.hpa.max_number_instances` | 25 | <img src="/images/logos/cloud-providers/aws-icon-light.svg" alt="AWS" class="badge-icon-aws-light" /><img src="/images/logos/cloud-providers/aws-icon-dark.svg" alt="AWS" class="badge-icon-aws-dark" /> <img src="/images/logos/cloud-providers/gcp-icon-new.svg" alt="GCP" class="badge-icon" /> <img src="/images/logos/cloud-providers/azure-icon.svg" alt="Azure" class="badge-icon" /> <img src="/images/logos/cloud-providers/scaleway-icon-light.svg" alt="Scaleway" class="badge-icon" /> | Max Nginx instances |
  </Accordion>

  <Accordion title="Nginx Configuration (10 settings)">
    | Setting | Default | Providers | Description |
    |---------|---------|-----------|-------------|
    | `nginx.controller.enable_client_ip` | false | <img src="/images/logos/cloud-providers/aws-icon-light.svg" alt="AWS" class="badge-icon-aws-light" /><img src="/images/logos/cloud-providers/aws-icon-dark.svg" alt="AWS" class="badge-icon-aws-dark" /> <img src="/images/logos/cloud-providers/gcp-icon-new.svg" alt="GCP" class="badge-icon" /> <img src="/images/logos/cloud-providers/azure-icon.svg" alt="Azure" class="badge-icon" /> <img src="/images/logos/cloud-providers/scaleway-icon-light.svg" alt="Scaleway" class="badge-icon" /> | Pass client IP to services |
    | `nginx.controller.enable_compression` | true | <img src="/images/logos/cloud-providers/aws-icon-light.svg" alt="AWS" class="badge-icon-aws-light" /><img src="/images/logos/cloud-providers/aws-icon-dark.svg" alt="AWS" class="badge-icon-aws-dark" /> <img src="/images/logos/cloud-providers/gcp-icon-new.svg" alt="GCP" class="badge-icon" /> <img src="/images/logos/cloud-providers/azure-icon.svg" alt="Azure" class="badge-icon" /> <img src="/images/logos/cloud-providers/scaleway-icon-light.svg" alt="Scaleway" class="badge-icon" /> | Enable Brotli compression |
    | `nginx.controller.use_forwarded_headers` | false | <img src="/images/logos/cloud-providers/aws-icon-light.svg" alt="AWS" class="badge-icon-aws-light" /><img src="/images/logos/cloud-providers/aws-icon-dark.svg" alt="AWS" class="badge-icon-aws-dark" /> <img src="/images/logos/cloud-providers/gcp-icon-new.svg" alt="GCP" class="badge-icon" /> <img src="/images/logos/cloud-providers/azure-icon.svg" alt="Azure" class="badge-icon" /> <img src="/images/logos/cloud-providers/scaleway-icon-light.svg" alt="Scaleway" class="badge-icon" /> | Use X-Forwarded-For header |
    | `nginx.controller.compute_full_forwarded_for` | false | <img src="/images/logos/cloud-providers/aws-icon-light.svg" alt="AWS" class="badge-icon-aws-light" /><img src="/images/logos/cloud-providers/aws-icon-dark.svg" alt="AWS" class="badge-icon-aws-dark" /> <img src="/images/logos/cloud-providers/gcp-icon-new.svg" alt="GCP" class="badge-icon" /> <img src="/images/logos/cloud-providers/azure-icon.svg" alt="Azure" class="badge-icon" /> <img src="/images/logos/cloud-providers/scaleway-icon-light.svg" alt="Scaleway" class="badge-icon" /> | Append to X-Forwarded-For |
    | `nginx.controller.log_format_upstream` | null | <img src="/images/logos/cloud-providers/aws-icon-light.svg" alt="AWS" class="badge-icon-aws-light" /><img src="/images/logos/cloud-providers/aws-icon-dark.svg" alt="AWS" class="badge-icon-aws-dark" /> <img src="/images/logos/cloud-providers/gcp-icon-new.svg" alt="GCP" class="badge-icon" /> <img src="/images/logos/cloud-providers/azure-icon.svg" alt="Azure" class="badge-icon" /> <img src="/images/logos/cloud-providers/scaleway-icon-light.svg" alt="Scaleway" class="badge-icon" /> | Custom log format |
    | `nginx.controller.log_format_escaping` | Default | <img src="/images/logos/cloud-providers/aws-icon-light.svg" alt="AWS" class="badge-icon-aws-light" /><img src="/images/logos/cloud-providers/aws-icon-dark.svg" alt="AWS" class="badge-icon-aws-dark" /> <img src="/images/logos/cloud-providers/gcp-icon-new.svg" alt="GCP" class="badge-icon" /> <img src="/images/logos/cloud-providers/azure-icon.svg" alt="Azure" class="badge-icon" /> <img src="/images/logos/cloud-providers/scaleway-icon-light.svg" alt="Scaleway" class="badge-icon" /> | Log format escaping |
    | `nginx.controller.http_snippet` | null | <img src="/images/logos/cloud-providers/aws-icon-light.svg" alt="AWS" class="badge-icon-aws-light" /><img src="/images/logos/cloud-providers/aws-icon-dark.svg" alt="AWS" class="badge-icon-aws-dark" /> <img src="/images/logos/cloud-providers/gcp-icon-new.svg" alt="GCP" class="badge-icon" /> <img src="/images/logos/cloud-providers/azure-icon.svg" alt="Azure" class="badge-icon" /> <img src="/images/logos/cloud-providers/scaleway-icon-light.svg" alt="Scaleway" class="badge-icon" /> | Custom HTTP config |
    | `nginx.controller.server_snippet` | null | <img src="/images/logos/cloud-providers/aws-icon-light.svg" alt="AWS" class="badge-icon-aws-light" /><img src="/images/logos/cloud-providers/aws-icon-dark.svg" alt="AWS" class="badge-icon-aws-dark" /> <img src="/images/logos/cloud-providers/gcp-icon-new.svg" alt="GCP" class="badge-icon" /> <img src="/images/logos/cloud-providers/azure-icon.svg" alt="Azure" class="badge-icon" /> <img src="/images/logos/cloud-providers/scaleway-icon-light.svg" alt="Scaleway" class="badge-icon" /> | Custom server config |
    | `nginx.controller.limit_request_status_code` | null | <img src="/images/logos/cloud-providers/aws-icon-light.svg" alt="AWS" class="badge-icon-aws-light" /><img src="/images/logos/cloud-providers/aws-icon-dark.svg" alt="AWS" class="badge-icon-aws-dark" /> <img src="/images/logos/cloud-providers/gcp-icon-new.svg" alt="GCP" class="badge-icon" /> <img src="/images/logos/cloud-providers/azure-icon.svg" alt="Azure" class="badge-icon" /> <img src="/images/logos/cloud-providers/scaleway-icon-light.svg" alt="Scaleway" class="badge-icon" /> | Rate limit status code |
    | `nginx.controller.custom_http_errors` | null | <img src="/images/logos/cloud-providers/aws-icon-light.svg" alt="AWS" class="badge-icon-aws-light" /><img src="/images/logos/cloud-providers/aws-icon-dark.svg" alt="AWS" class="badge-icon-aws-dark" /> <img src="/images/logos/cloud-providers/gcp-icon-new.svg" alt="GCP" class="badge-icon" /> <img src="/images/logos/cloud-providers/azure-icon.svg" alt="Azure" class="badge-icon" /> <img src="/images/logos/cloud-providers/scaleway-icon-light.svg" alt="Scaleway" class="badge-icon" /> | Custom error codes |
  </Accordion>

  <Accordion title="Nginx Default Backend (3 settings)">
    | Setting | Default | Providers | Description |
    |---------|---------|-----------|-------------|
    | `nginx.default_backend.enabled` | false | <img src="/images/logos/cloud-providers/aws-icon-light.svg" alt="AWS" class="badge-icon-aws-light" /><img src="/images/logos/cloud-providers/aws-icon-dark.svg" alt="AWS" class="badge-icon-aws-dark" /> <img src="/images/logos/cloud-providers/gcp-icon-new.svg" alt="GCP" class="badge-icon" /> <img src="/images/logos/cloud-providers/azure-icon.svg" alt="Azure" class="badge-icon" /> <img src="/images/logos/cloud-providers/scaleway-icon-light.svg" alt="Scaleway" class="badge-icon" /> | Enable default backend |
    | `nginx.default_backend.image_repository` | null | <img src="/images/logos/cloud-providers/aws-icon-light.svg" alt="AWS" class="badge-icon-aws-light" /><img src="/images/logos/cloud-providers/aws-icon-dark.svg" alt="AWS" class="badge-icon-aws-dark" /> <img src="/images/logos/cloud-providers/gcp-icon-new.svg" alt="GCP" class="badge-icon" /> <img src="/images/logos/cloud-providers/azure-icon.svg" alt="Azure" class="badge-icon" /> <img src="/images/logos/cloud-providers/scaleway-icon-light.svg" alt="Scaleway" class="badge-icon" /> | Backend image repository |
  ...
  <Accordion title="Service Resources (2 settings)">
    | Setting | Default | Providers | Description |
    |---------|---------|-----------|-------------|
    | `allow_service_cpu_overcommit` | false | <img src="/images/logos/cloud-providers/aws-icon-light.svg" alt="AWS" class="badge-icon-aws-light" /><img src="/images/logos/cloud-providers/aws-icon-dark.svg" alt="AWS" class="badge-icon-aws-dark" /> <img src="/images/logos/cloud-providers/gcp-icon-new.svg" alt="GCP" class="badge-icon" /> <img src="/images/logos/cloud-providers/azure-icon.svg" alt="Azure" class="badge-icon" /> <img src="/images/logos/cloud-providers/scaleway-icon-light.svg" alt="Scaleway" class="badge-icon" /> | ⚠️ Allow CPU overcommit |
    | `allow_service_ram_overcommit` | false | <img src="/images/logos/cloud-providers/aws-icon-light.svg" alt="AWS" class="badge-icon-aws-light" /><img src="/images/logos/cloud-providers/aws-icon-dark.svg" alt="AWS" class="badge-icon-aws-dark" /> <img src="/images/logos/cloud-providers/gcp-icon-new.svg" alt="GCP" class="badge-icon" /> <img src="/images/logos/cloud-providers/azure-icon.svg" alt="Azure" class="badge-icon" /> <img src="/images/logos/cloud-providers/scaleway-icon-light.svg" alt="Scaleway" class="badge-icon" /> | ⚠️ Allow memory overcommit |
  </Accordion>

  <Accordion title="Database Access Control (8 settings)">
    | Setting | Default | Providers | Description |
    |---------|---------|-----------|-------------|
    | `database.postgresql.deny_any_access` | false | <img src="/images/logos/cloud-providers/aws-icon-light.svg" alt="AWS" class="badge-icon-aws-light" /><img src="/images/logos/cloud-providers/aws-icon-dark.svg" alt="AWS" class="badge-icon-aws-dark" /> <img src="/images/logos/cloud-providers/gcp-icon-new.svg" alt="GCP" class="badge-icon" /> <img src="/images/logos/cloud-providers/azure-icon.svg" alt="Azure" class="badge-icon" /> <img src="/images/logos/cloud-providers/scaleway-icon-light.svg" alt="Scaleway" class="badge-icon" /> | Deny all PostgreSQL access |
    | `database.postgresql.allowed_cidrs` | ["0.0.0.0/0"] | <img src="/images/logos/cloud-providers/aws-icon-light.svg" alt="AWS" class="badge-icon-aws-light" /><img src="/images/logos/cloud-providers/aws-icon-dark.svg" alt="AWS" class="badge-icon-aws-dark" /> <img src="/images/logos/cloud-providers/gcp-icon-new.svg" alt="GCP" class="badge-icon" /> <img src="/images/logos/cloud-providers/azure-icon.svg" alt="Azure" class="badge-icon" /> <img src="/images/logos/cloud-providers/scaleway-icon-light.svg" alt="Scaleway" class="badge-icon" /> | PostgreSQL allowed CIDRs |
    | `database.mysql.deny_any_access` | false | <img src="/images/logos/cloud-providers/aws-icon-light.svg" alt="AWS" class="badge-icon-aws-light" /><img src="/images/logos/cloud-providers/aws-icon-dark.svg" alt="AWS" class="badge-icon-aws-dark" /> <img src="/images/logos/cloud-providers/gcp-icon-new.svg" alt="GCP" class="badge-icon" /> <img src="/images/logos/cloud-providers/azure-icon.svg" alt="Azure" class="badge-icon" /> <img src="/images/logos/cloud-providers/scaleway-icon-light.svg" alt="Scaleway" class="badge-icon" /> | Deny all MySQL access |
    | `database.mysql.allowed_cidrs` | ["0.0.0.0/0"] | <img src="/images/logos/cloud-providers/aws-icon-light.svg" alt="AWS" class="badge-icon-aws-light" /><img src="/images/logos/cloud-providers/aws-icon-dark.svg" alt="AWS" class="badge-icon-aws-dark" /> <img src="/images/logos/cloud-providers/gcp-icon-new.svg" alt="GCP" class="badge-icon" /> <img src="/images/logos/cloud-providers/azure-icon.svg" alt="Azure" class="badge-icon" /> <img src="/images/logos/cloud-providers/scaleway-icon-light.svg" alt="Scaleway" class="badge-icon" /> | MySQL allowed CIDRs |
    | `database.mongodb.deny_any_access` | false | <img src="/images/logos/cloud-providers/aws-icon-light.svg" alt="AWS" class="badge-icon-aws-light" /><img src="/images/logos/cloud-providers/aws-icon-dark.svg" alt="AWS" class="badge-icon-aws-dark" /> <img src="/images/logos/cloud-providers/gcp-icon-new.svg" alt="GCP" class="badge-icon" /> <img src="/images/logos/cloud-providers/azure-icon.svg" alt="Azure" class="badge-icon" /> <img src="/images/logos/cloud-providers/scaleway-icon-light.svg" alt="Scaleway" class="badge-icon" /> | Deny all MongoDB access |
    | `database.mongodb.allowed_cidrs` | ["0.0.0.0/0"] | <img src="/images/logos/cloud-providers/aws-icon-light.svg" alt="AWS" class="badge-icon-aws-light" /><img src="/images/logos/cloud-providers/aws-icon-dark.svg" alt="AWS" class="badge-icon-aws-dark" /> <img src="/images/logos/cloud-providers/gcp-icon-new.svg" alt="GCP" class="badge-icon" /> <img src="/images/logos/cloud-providers/azure-icon.svg" alt="Azure" class="badge-icon" /> <img src="/images/logos/cloud-providers/scaleway-icon-light.svg" alt="Scaleway" class="badge-icon" /> | MongoDB allowed CIDRs |
    | `database.redis.deny_any_access` | false | <img src="/images/logos/cloud-providers/aws-icon-light.svg" alt="AWS" class="badge-icon-aws-light" /><img src="/images/logos/cloud-providers/aws-icon-dark.svg" alt="AWS" class="badge-icon-aws-dark" /> <img src="/images/logos/cloud-providers/gcp-icon-new.svg" alt="GCP" class="badge-icon" /> <img src="/images/logos/cloud-providers/azure-icon.svg" alt="Azure" class="badge-icon" /> <img src="/images/logos/cloud-providers/scaleway-icon-light.svg" alt="Scaleway" class="badge-icon" /> | Deny all Redis access |
    | `database.redis.allowed_cidrs` | ["0.0.0.0/0"] | <img src="/images/logos/cloud-providers/aws-icon-light.svg" alt="AWS" class="badge-icon-aws-light" /><img src="/images/logos/cloud-providers/aws-icon-dark.svg" alt="AWS" class="badge-icon-aws-dark" /> <img src="/images/logos/cloud-providers/gcp-icon-new.svg" alt="GCP" class="badge-icon" /> <img src="/images/logos/cloud-providers/azure-icon.svg" alt="Azure" class="badge-icon" /> <img src="/images/logos/cloud-providers/scaleway-icon-light.svg" alt="Scaleway" class="badge-icon" /> | Redis allowed CIDRs |
  </Accordion>
  ...
  <Accordion title="Miscellaneous (6 settings)">
    | Setting | Default | Providers | Description |
    |---------|---------|-----------|-------------|
    | `storageclass.fast_ssd` | varies | <img src="/images/logos/cloud-providers/aws-icon-light.svg" alt="AWS" class="badge-icon-aws-light" /><img src="/images/logos/cloud-providers/aws-icon-dark.svg" alt="AWS" class="badge-icon-aws-dark" /> <img src="/images/logos/cloud-providers/gcp-icon-new.svg" alt="GCP" class="badge-icon" /> <img src="/images/logos/cloud-providers/azure-icon.svg" alt="Azure" class="badge-icon" /> <img src="/images/logos/cloud-providers/scaleway-icon-light.svg" alt="Scaleway" class="badge-icon" /> | Storage class for SSD |
