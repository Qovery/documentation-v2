...
<CardGroup cols={2}>
  <Card title="PostgreSQL" icon="database" href="/guides/getting-started/connect-database">
    Powerful open-source relational database with advanced features
  </Card>

  <Card title="MySQL" icon="database" href="/guides/getting-started/connect-database">
    Popular open-source relational database management system
  </Card>

  <Card title="MongoDB" icon="database" href="/guides/getting-started/connect-database">
    Document-oriented NoSQL database for flexible data models
  </Card>

  <Card title="Redis" icon="database" href="/guides/getting-started/connect-database">
...
<CardGroup cols={2}>
  <Card title="Use Managed Mode for Production" icon="shield-check" href="/configuration/database">
    Always use managed databases for production workloads to ensure reliability and automatic backups
  </Card>

  <Card title="Keep Databases Private" icon="lock" href="/configuration/database">
    Use private accessibility unless public access is absolutely required for security
  </Card>

  <Card title="Right-Size Resources" icon="gauge" href="/configuration/database">
    Start with smaller instances and scale up based on actual usage patterns
  </Card>

  <Card title="Test Version Upgrades" icon="vial" href="/configuration/database">
    Always test database upgrades in staging before applying to production
  </Card>

  <Card title="Monitor Performance" icon="chart-line" href="/configuration/monitoring">
    Use database metrics to identify performance issues and optimize queries
  </Card>

  <Card title="Regular Backups" icon="floppy-disk" href="/security-and-compliance/overview">
