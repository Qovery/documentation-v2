...
Required permissions for AWS credentials:
...
Required permissions for GCP credentials:
- Compute Engine
- Kubernetes Engine
- VPC networking
- Service accounts
...
Required permissions for Azure credentials:
- Virtual Machines
...
Required permissions for Scaleway credentials:
- Kubernetes Kapsule
- Instances
- Private Networks
- Object Storage
