...
| Icon | Service Type |
|------|--------------|
| ![Application](/img/advanced_settings/application.svg) | Application |
| ![Container](/img/advanced_settings/container.svg) | Container |
| ![Cronjob](/img/advanced_settings/cronjob.svg) | Cronjob |
| ![Job](/img/advanced_settings/job.svg) | Job |
| ![Helm](/img/advanced_settings/helm.svg) | Helm |
