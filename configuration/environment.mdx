...
Export your environment configuration as Terraform manifests for infrastructure as code management:
...
<Steps>
  ...
  <Step title="Use Terraform">
    Use the exported configuration with the [Qovery Terraform Provider](/terraform/overview)
  </Step>
</Steps>
