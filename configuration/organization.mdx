...
<Steps>
  ...
  <Step title="Create New Organization">
    ...
    ![Qovery - create organization after signing up](/images/configuration/organization/create_organization_after_signing_up.png)
  </Step>
...
![Qovery - change organization](/images/configuration/organization/change_organization.png)
...
<CardGroup cols={2}>
  ...
  <Card title="Helm Repository" icon="/images/logos/helm-icon-light.svg">
...
<CardGroup cols={2}>
  <Card title="Projects" href="/configuration/project">
