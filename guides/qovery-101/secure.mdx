...
### Step 1: Secure Your Organization
...
<Steps>
  <Step title="Enable Two-Factor Authentication">
    ...
    **Enforce for Organization**:
    ...
    3. Set grace period for compliance (e.g., 7 days)
  </Step>

  <Step title="Configure Single Sign-On (SSO)">
    ...
    <Tabs>
      <Tab title="Google Workspace">
        ...
        Setup:
          1. Enable Google OAuth in Qovery
          2. Configure authorized domains
          3. Test SSO login
          4. Enforce SSO for organization
        ```
      </Tab>
      ...
      <Tab title="Okta">
        ...
        Setup:
          1. Create SAML 2.0 app in Okta
          2. Configure Qovery as service provider
          3. Copy IdP metadata URL
          4. Configure in Qovery
  ...
  <Step title="Set Up Audit Logging">
    ...
    Export: Available via API or S3
    ```
...
<Steps>
  ...
  <Step title="Configure VPC Peering">
    ...
    **AWS VPC Peering**:
    ...
    See detailed guide: [AWS VPC Peering](/guides/others/aws-vpc-peering)
  </Step>
</Steps>
