...
description: "Detailed step-by-step guide to deploying your first application with Qovery"
---

<Note>
**New to Qovery?** Check out our [Quick Start Guide](/quickstart) for a complete walkthrough including infrastructure setup.
</Note>

## Overview

This guide provides detailed instructions for deploying your first application on Qovery, from connecting your Git repository to seeing your app live.
...
- A Kubernetes cluster connected to Qovery ([Quick Start Guide](/quickstart))

## Step 1: Create a Project

[Projects](/configuration/project) help you organize related applications and environments.
...
[Environments](/configuration/environment) represent different stages of your application lifecycle (dev, staging, production).
...
<Steps>
  ...
  <Step title="Configure Build">
    Qovery will auto-detect your Dockerfile and use it automatically.
    ...
    Learn more about [application configuration](/configuration/application).
  </Step>
...
2. **Built a container image** using Docker
...
<AccordionGroup>
  ...
  <Accordion title="Application Crashes">
    ...
    **Solutions**:
    - Check [application logs](/configuration/deployment/logs) for errors
    - Verify [environment variables](/configuration/environment-variables) are set correctly
...
- **Build**: Automatic (Dockerfile detected)
...
<Tip>
**Use Auto-Deploy**: Enable [automatic deployments](/configuration/deployment/auto-deploy) for development and staging. Keep production manual for control.
</Tip>
