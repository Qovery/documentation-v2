...
<Check>A cluster connected to Qovery - [Setup guide](/installation/aws)</Check>
<Check>Git repository with your application code (GitHub, GitLab, or Bitbucket)</Check>

<Note>
Don't have a cluster yet? Follow our [Quick Start Guide](/quickstart) for complete setup.
</Note>
