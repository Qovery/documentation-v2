...
<CardGroup cols={2}>
  <Card title="Getting Started Guide" icon="rocket" href="/copilot/getting-started">
    Learn how to use Qovery AI Copilot effectively
  </Card>
  ...
  <Card title="Full MCP Documentation" icon="file" href="/using-qovery/interface/mcp-server">
