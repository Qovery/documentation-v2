...
Qovery automatically generates and injects connection credentials as environment variables in your applications.
...
<Info>
Learn more: [AWS VPC Peering Guide](/guides/others/aws-vpc-peering)
</Info>
...
<Info>
Learn more: [Terraform Integration](/integrations/terraform/overview)
</Info>
...
<CardGroup cols={2}>
  ...
  <Card title="Environment Variables" href="/using-qovery/configuration/environment">
    Learn about environment variable management
  </Card>

  <Card title="VPC Peering" href="/guides/others/aws-vpc-peering">
    Connect to external databases via VPC peering
  </Card>

  <Card title="Lifecycle Jobs" href="/using-qovery/configuration/lifecycle-job">
