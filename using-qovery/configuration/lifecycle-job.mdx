...
<CardGroup cols={2}>
  <Card title="Cron Jobs" icon="clock" href="/using-qovery/configuration/cronjob">
  ...
  <Card title="Deployment Pipeline" icon="diagram-project" href="/using-qovery/deployment/deployment-pipeline">
