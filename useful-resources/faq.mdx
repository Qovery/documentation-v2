...
<AccordionGroup>
  ...
  <Accordion title="How can I contact you?">
    Feel free to join our [forum](https://discuss.qovery.com) or contact us by email at hello (at) qovery.com or via the Intercom chat.
  </Accordion>
</AccordionGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="Contact Support" icon="headset" href="/useful-resources/help-and-support">
