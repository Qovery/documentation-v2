...
<CardGroup cols={2}>
  ...
  <Card title="Availability" icon="server" href="/security-and-compliance/overview">
...
<CardGroup cols={2}>
  ...
  <Card title="Scaleway Deployment" icon="server" href="/integrations/kubernetes/scaleway/overview">
