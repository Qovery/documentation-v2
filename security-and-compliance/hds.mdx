...
<CardGroup cols={2}>
  ...
  <Card title="Integrity" icon="check-double">
...
<CardGroup cols={2}>
  <Card title="Security Policy" icon="file-contract">
  ...
  <Card title="Audit Reports" icon="file-certificate">
    Internal and external audit reports
  </Card>

  <Card title="Incident Logs" icon="clipboard">
    Security incident documentation
  </Card>

  <Card title="Training Records" icon="graduation-cap">
...
<CardGroup cols={2}>
  <Card title="Compliance Consulting" icon="user-tie">
  ...
  <Card title="Security Assessment" icon="shield-check">
...
<CardGroup cols={2}>
  <Card title="Contact Sales" icon="comments">
