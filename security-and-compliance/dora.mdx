...
<CardGroup cols={2}>
  <Card title="ICT Risk Management" icon="shield" href="/security-and-compliance/overview">
    Comprehensive risk management framework for ICT systems
  </Card>

  <Card title="Incident Reporting" icon="bell" href="/security-and-compliance/overview">
    Mandatory reporting of major ICT-related incidents
  </Card>

  <Card title="Digital Resilience Testing" icon="flask" href="/security-and-compliance/overview">
    Regular testing including advanced scenarios (TLPT)
  </Card>

  <Card title="Third-Party Risk" icon="handshake" href="/security-and-compliance/overview">
    Due diligence and oversight of ICT service providers
  </Card>

  <Card title="Information Sharing" icon="share-nodes" href="/security-and-compliance/overview">
...
<CardGroup cols={2}>
  <Card title="Audit Logs" icon="clock-rotate-left" href="/security-and-compliance/overview">
    Immutable audit trail of all actions with long-term retention (1+ years)
  </Card>

  <Card title="Data Residency" icon="location-dot" href="/integrations/kubernetes/overview">
    Deploy in EU regions to meet data localization requirements
  </Card>

  <Card title="Encryption" icon="lock" href="/security-and-compliance/overview">
  ...
  <Card title="Backup & Recovery" icon="cloud-arrow-up" href="/security-and-compliance/overview">
