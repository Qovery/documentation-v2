...
<CardGroup cols={2}>
  <Card title="AWS Consistency" icon="aws">
...
<CardGroup cols={2}>
  ...
  <Card title="Cloud EKS" icon="aws" href="/integrations/kubernetes/eks/overview">
    Compare with cloud-based EKS
  </Card>

  <Card title="Generic BYOK" icon="dharmachakra" href="/integrations/kubernetes/byok">
