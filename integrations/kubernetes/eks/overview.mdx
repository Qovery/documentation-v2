...
<CardGroup cols={2}>
  ...
  <Card title="Bring Your Own EKS (BYOK)" icon="server" href="/integrations/kubernetes/eks/byok">
    **Full Control**
...
<CardGroup cols={2}>
  ...
  <Card title="Monitoring" icon="chart-line">
    ...
    - Use Qovery Observe
    - Consider Datadog/New Relic for production
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  <Card title="Qovery-Managed EKS Setup" icon="rocket" href="/integrations/kubernetes/eks/managed">
    Set up automated EKS cluster
  </Card>

  <Card title="BYOK EKS Setup" icon="plug" href="/integrations/kubernetes/eks/byok">
    Connect existing EKS cluster
  </Card>

  <Card title="AWS Installation Guide" icon="book" href="/integrations/kubernetes/eks/overview">
