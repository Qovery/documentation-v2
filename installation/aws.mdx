...
<Steps>
  ...
  <Step title="Select Instance Types">
    **Select ALL instance types** Karpenter can use:

    Recommended selections:
    - ✅ **t3.medium** (2 vCPU, 4GB)
    - ✅ **t3.large** (2 vCPU, 8GB) ← Start here
    - ✅ **t3.xlarge** (4 vCPU, 16GB)
    - ✅ **t3.2xlarge** (8 vCPU, 32GB)
    - ✅ **m5.large, m5.xlarge** (alternative instance family)
    - ✅ **m6i.large, m6i.xlarge** (newer generation)

    <Info>
    **Select multiple types!** Karpenter will automatically pick the best instance from your selections based on cost, availability, and workload requirements. Enable **spot instances** for 60-90% savings.
    </Info>
