...
<CardGroup cols={2}>
  ...
  <Card title="Set Up CI/CD" icon="code-branch" href="/integrations/ci-cd/overview">
    Automate deployments with GitHub Actions or GitLab CI
  </Card>

  <Card title="Monitor Your Cluster" icon="chart-line" href="/integrations/observability/overview">
...
- [Qovery Community Forum](https://discuss.qovery.com)
