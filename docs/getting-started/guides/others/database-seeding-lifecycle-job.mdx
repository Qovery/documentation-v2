...
<CardGroup cols={2}>
  ...
  <Card title="Example Repository" icon="/images/logos/github-icon.svg" href="https://github.com/Qovery/lifecycle-job-examples/tree/main/examples/seed-postgres-database-with-sql-script">
