...
<CardGroup cols={2}>
  <Card title="Managed Cluster (Recommended)" icon="cloud" href="/getting-started/quickstart">
...
<CardGroup cols={2}>
  <Card title="CI/CD Integration Guide" icon="rotate" href="/configuration/integrations/ci-cd/github-actions">
  ...
  <Card title="Multi-Environment Setup" icon="layer-group" href="/getting-started/guides/use-cases/production-environment-management">
