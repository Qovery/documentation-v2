...
<CardGroup cols={2}>
  <Card title="Install on AWS" icon="/images/logos/cloud-providers/aws-icon.svg" href="/getting-started/installation/aws">
    Complete guide to create EKS cluster with Karpenter auto-scaling
  </Card>
  <Card title="Install on GCP" icon="/images/logos/cloud-providers/gcp-icon.svg" href="/getting-started/installation/gcp">
    Complete guide to create GKE cluster with auto-scaling
  </Card>
  <Card title="Install on Azure" icon="/images/logos/cloud-providers/azure-icon.svg" href="/getting-started/installation/azure">
...
[Learn more about BYOK →](/configuration/integrations/kubernetes/byok)
