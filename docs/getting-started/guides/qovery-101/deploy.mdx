...
<AccordionGroup>
  ...
  <Accordion title="Helm Charts" icon="/images/logos/helm-icon-light.svg">
...
<CardGroup cols={2}>
  ...
  <Card title="CI/CD Integration" icon="pipe" href="/configuration/integrations/ci-cd/github-actions">
