...
<AccordionGroup>
  <Accordion title="Applications" icon="rocket">
    **Deploy from Git repositories**
    ...
    - **Supported languages**: Any language with a Dockerfile
  ...
  <Accordion title="Helm Charts" icon="/images/logos/helm-icon.svg">
    **Deploy packaged applications**

    - **Public repositories**: Any Helm chart (e.g., Prometheus, Grafana, Redis, Elasticsearch)
...
<CardGroup cols={2}>
  <Card title="Observe Deployments" icon="eye" href="/getting-started/guides/qovery-101/observe">
  ...
  <Card title="CI/CD Integration" icon="arrows-rotate" href="/configuration/integrations/ci-cd/github-actions">
