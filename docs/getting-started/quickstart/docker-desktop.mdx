  ...
  <Step title="Step 1: Install Qovery CLI">
    <Tabs>
      ...
      <Tab title="Windows (WSL)">
        <Warning>
        **WSL Required**: All Qovery commands must be run in a WSL (Windows Subsystem for Linux) terminal. If you haven't installed WSL yet, follow [Microsoft's WSL installation guide](https://learn.microsoft.com/en-us/windows/wsl/install).
        </Warning>

        To download and install Qovery CLI on Windows using WSL:
