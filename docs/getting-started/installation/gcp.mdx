...
<Steps>
  ...
  <Step title="Copy the Command">
    ...
    <Info>
    This script creates a service account with minimal required permissions. You can inspect the script at: [create_credentials_gcp.sh](/files/create_credentials_gcp.sh)
    </Info>
  </Step>
</Steps>
