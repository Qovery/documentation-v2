...
<Steps>
  <Step title="Open Cluster Creation">
    ...
    <Frame>
      <img src="/images/install-qovery/common/add-cluster.jpg" alt="Create cluster in Qovery Console" />
    </Frame>
  </Step>
...
<AccordionGroup>
  ...
  <Accordion title="Cluster creation is stuck">
    ...
    - Contact support through the [Community Forum](https://discuss.qovery.com/)
  </Accordion>
