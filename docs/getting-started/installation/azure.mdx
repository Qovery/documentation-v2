...
<Steps>
  ...
  <Step title="Copy the Command">
    ...
    <Info>
    This command creates a service principal using Azure's app registration. It's completely secure and you can inspect the script at: [create_credentials_azure.sh](/files/create_credentials_azure.sh)
    </Info>
  </Step>
</Steps>
