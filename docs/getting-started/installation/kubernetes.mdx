...
<Warning>
  **For Kubernetes Experts Only**: Qovery BYOK is for Kubernetes experts who
  want to manage their own Kubernetes cluster. If you are not familiar with
  Kubernetes, we recommend using [Qovery-Managed Kubernetes](/installation/aws)
  on AWS, GCP, Azure, or Scaleway.
</Warning>
...
<Tip>
  ...
  Integration Guide](/integrations/kubernetes/byok).
</Tip>
