...
<CardGroup cols={2}>
  ...
  <Card title="Availability" icon="/images/logos/cloud-providers/scaleway-icon.svg" href="/getting-started/security-and-compliance/overview">
...
<CardGroup cols={2}>
  ...
  <Card title="Scaleway Deployment" icon="/images/logos/cloud-providers/scaleway-icon.svg" href="/configuration/integrations/kubernetes/scaleway/overview">
