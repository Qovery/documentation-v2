...
<CardGroup cols={3}>
  <Card title="Multi-Cloud Kubernetes" icon="dharmachakra" href="/guides/qovery-101/provision">
...
<CardGroup cols={3}>
  <Card title="Applications" icon="rocket" href="/guides/qovery-101/deploy">
    **All Languages & Frameworks**

    Node.js, Python, Go, Java, PHP, Ruby, .NET, containers. Framework auto-detection and automatic builds
  </Card>
  <Card title="Helm Charts" icon="/images/logos/helm-icon-light.svg">
...
<CardGroup cols={2}>
  <Card title="Qovery Observe (Built-in)" icon="eye" href="/guides/qovery-101/observe">
...
<CardGroup cols={3}>
  <Card title="Cost Optimization" icon="piggy-bank" href="/guides/qovery-101/optimize">
...
<CardGroup cols={3}>
  <Card title="Compliance Certified" icon="file-certificate" href="/guides/qovery-101/secure">
