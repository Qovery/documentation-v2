...
```bash
curl -X GET "https://api.qovery.com/organization/{org_id}/project" \
...
```bash
curl -X POST "https://api.qovery.com/project/{project_id}/environment" \
  -H "Authorization: Token ${QOVERY_API_TOKEN}" \
  -H "Content-Type: application/json" \
  -d '{
    "name": "staging",
...
```bash
curl -X POST "https://api.qovery.com/application/{app_id}/deploy" \
  -H "Authorization: Token ${QOVERY_API_TOKEN}" \
  -H "Content-Type: application/json" \
  -d '{
...
```bash
curl -X GET "https://api.qovery.com/application/{app_id}/status" \
  -H "Authorization: Token ${QOVERY_API_TOKEN}" \
  -H "Content-Type: application/json"
```
...
```bash
curl -X POST "https://api.qovery.com/application/{app_id}/environmentVariable" \
  -H "Authorization: Token ${QOVERY_API_TOKEN}" \
  -H "Content-Type: application/json" \
  -d '{
    "key": "DATABASE_URL",
...
```bash
curl -X POST "https://api.qovery.com/application/{app_id}/secret" \
  -H "Authorization: Token ${QOVERY_API_TOKEN}" \
  -H "Content-Type: application/json" \
  -d '{
    "key": "API_KEY",
...
```bash
curl -X GET "https://api.qovery.com/application/{app_id}/environmentVariable" \
  -H "Authorization: Token ${QOVERY_API_TOKEN}" \
  -H "Content-Type: application/json"
```
...
```bash
curl -X GET "https://api.qovery.com/application/{app_id}/log?tail=100" \
  -H "Authorization: Token ${QOVERY_API_TOKEN}" \
  -H "Content-Type: application/json"
```
...
```bash
curl -X POST "https://api.qovery.com/environment/{env_id}/database" \
  -H "Authorization: Token ${QOVERY_API_TOKEN}" \
  -H "Content-Type: application/json" \
  -d '{
    "name": "main-db",
...
```bash
curl -X POST "https://api.qovery.com/database/{db_id}/deploy" \
  -H "Authorization: Token ${QOVERY_API_TOKEN}" \
  -H "Content-Type: application/json"
```
...
```bash
curl -X POST "https://api.qovery.com/organization/{org_id}/webhook" \
  -H "Authorization: Token ${QOVERY_API_TOKEN}" \
  -H "Content-Type: application/json" \
  -d '{
  ...
  deploy:
    ...
    steps:
      - name: Deploy application
        run: |
          curl -X POST "https://api.qovery.com/application/${{ secrets.QOVERY_APP_ID }}/deploy" \
...
deploy:
  ...
  script:
    - |
      curl -X POST "https://api.qovery.com/application/${QOVERY_APP_ID}/deploy" \
        -H "Authorization: Token ${QOVERY_API_TOKEN}" \
        -H "Content-Type: application/json" \
