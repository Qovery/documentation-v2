...
<CardGroup cols={2}>
  ...
  <Card title="SSL/TLS Certificates" icon="lock" href="/security-and-compliance/overview">
  ...
  <Card title="Networking" icon="network-wired" href="/integrations/api-gateway-nginx">
