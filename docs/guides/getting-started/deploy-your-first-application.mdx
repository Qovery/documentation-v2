...
<Check>Kubernetes cluster - [Install a cluster](/installation/aws) or [connect your own](/integrations/kubernetes/byok)</Check>
    ...
    **Requirements:**
    ...
    <Steps>
      ...
      <Step title="Configure Health Checks (Optional)">
        ...
        - **Liveness Probe**: HTTP, TCP, or exec checks
...
<AccordionGroup>
  <Accordion title="Build Failed (Git Repository)">
    ...
    **Solutions**:
    ...
    - Increase build resources if needed
  </Accordion>
...
<CardGroup cols={2}>
  ...
  <Card title="Deploy Helm Charts" icon="helm" href="/configuration/helm">
