...
Download the latest release from [GitHub Releases](https://github.com/Qovery/qovery-cli/releases) and add it to your PATH.
...
<CardGroup cols={2}>
  <Card title="Deploy Applications" icon="rocket" href="/cli/commands">
    Deploy and redeploy applications instantly from the terminal
  </Card>
  <Card title="Environment Management" icon="layer-group" href="/cli/commands">
    Create, update, and manage environments
  </Card>
  <Card title="Live Logs" icon="terminal" href="/cli/commands">
    Stream real-time logs from your applications
  </Card>
  <Card title="Shell Access" icon="code" href="/cli/commands">
