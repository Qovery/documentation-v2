...
<CardGroup cols={2}>
  <Card title="Data Security" icon="shield" href="/security-and-compliance/overview">
    Technical and organizational measures to protect health data
  </Card>

  <Card title="Confidentiality" icon="user-lock" href="/security-and-compliance/overview">
    Ensuring only authorized persons access health data
  </Card>

  <Card title="Integrity" icon="check-double" href="/security-and-compliance/overview">
    Preventing unauthorized modification of health data
  </Card>

  <Card title="Availability" icon="/images/logos/cloud-providers/scaleway-icon-light.svg" href="/security-and-compliance/overview">
...
<CardGroup cols={2}>
  <Card title="Security Policy" icon="file-contract" href="/security-and-compliance/overview">
    Comprehensive information security policy
  </Card>

  <Card title="Risk Assessment" icon="triangle-exclamation" href="/security-and-compliance/overview">
    Regular risk assessments and mitigation plans
  </Card>

  <Card title="Procedures" icon="list-check" href="/security-and-compliance/overview">
    Documented operational procedures
  </Card>

  <Card title="Audit Reports" icon="file-certificate" href="/security-and-compliance/soc2">
    Internal and external audit reports
  </Card>

  <Card title="Incident Logs" icon="clipboard" href="/security-and-compliance/overview">
    Security incident documentation
  </Card>

  <Card title="Training Records" icon="graduation-cap" href="/security-and-compliance/overview">
...
<CardGroup cols={2}>
  ...
  <Card title="Scaleway Deployment" icon="/images/logos/cloud-providers/scaleway-icon-light.svg" href="/integrations/kubernetes/scaleway/overview">
