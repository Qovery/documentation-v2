...
<AccordionGroup>
  ...
  <Accordion title="Database Restore" icon="database">
    ...
    <CardGroup cols={2}>
      <Card title="AWS RDS Restore" icon="aws" href="https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/CHAP_CommonTasks.BackupRestore.html">
        Amazon RDS backup and restore guide
      </Card>

      <Card title="GCP Cloud SQL Restore" icon="google" href="https://cloud.google.com/sql/docs/mysql/backup-recovery/restoring">
        Google Cloud SQL restore documentation
      </Card>

      <Card title="Azure Database Restore" icon="microsoft" href="https://docs.microsoft.com/en-us/azure/mysql/concepts-backup">
        Azure Database backup and restore
      </Card>

      <Card title="Scaleway Database Restore" icon="server" href="https://www.scaleway.com/en/docs/managed-databases/postgresql-and-mysql/how-to/restore-a-backup/">
...
<CardGroup cols={3}>
  ...
  <Card title="GDPR" icon="gavel" href="/security-and-compliance/gdpr">
    European data protection compliance
  </Card>

  <Card title="HIPAA" icon="hospital" href="/security-and-compliance/hipaa">
    Healthcare data protection
  </Card>

  <Card title="HDS" icon="briefcase-medical" href="/security-and-compliance/hds">
    French health data hosting
  </Card>

  <Card title="DORA" icon="landmark" href="/security-and-compliance/dora">
...
<CardGroup cols={2}>
  <Card title="Audit Logs" icon="list" href="/security-and-compliance/audit-logs">
