...
<CardGroup cols={2}>
  ...
  <Card title="Application with Database" icon="database" href="/terraform/application-with-database">
  ...
  <Card title="Advanced Patterns" icon="code" href="/terraform/advanced-patterns">
