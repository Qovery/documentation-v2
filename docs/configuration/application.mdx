    ...
    <Tabs>
      <Tab title="Model A: Shared IAM Role">
        ...
        **Parameters**:
        ...
        - **Trigger Authentication YAML**:
          - `podIdentity.provider: aws`: Use AWS pod identity (inherits from application's service account)

        <Info>
        With `podIdentity.provider: aws` (no roleArn), KEDA automatically inherits the IAM role from your application's service account configured in advanced settings.
        </Info>
      ...
      <Tab title="Model B: KEDA-Only IAM Role">
        ...
        **Configuration**:
        ...
        3. Configure both scaler and trigger authentication YAML with the role ARN
        ...
        **Parameters**:
        ...
        <Info>
        Specifying `roleArn` in the trigger authentication allows KEDA to use a dedicated IAM role separate from your application, providing better security isolation.
        </Info>
