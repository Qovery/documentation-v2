...
<Tabs>
  ...
  <Tab title="KEDA (Event-Driven)">
    ...
    **Prerequisite: Enable KEDA at Cluster Level**
    ...
    <Frame>
      <img src="/images/configuration/application/cluster-keda-activation.png" alt="Enable KEDA in cluster advanced settings" />
    </Frame>

    <Warning>
    After enabling KEDA, you must redeploy your cluster for the feature to become available.
    </Warning>
    ...
    <Tabs>
      ...
      <Tab title="Redis">
        ...
        **Configuration Parameters**:
        ...
        - `activationListLength` - Minimum list length to activate scaling
      ...
      <Tab title="RabbitMQ">
        ...
        **Configuration Parameters**:
        ...
        - `activationValue` - Minimum queue length to activate scaling
