    ...
    <Tabs>
      <Tab title="Model A: Shared IAM Role">
        ...
        **Configuration**:
        ...
        2. Configure both scaler and trigger authentication YAML
      ...
      <Tab title="Model B: KEDA-Only IAM Role">
        ...
        **Configuration**:
        ...
        2. Provide the IAM role ARN in the scaler configuration
        ...
        **Parameters**:
        ...
        - **Trigger Authentication YAML**:
          - `podIdentity.provider: aws`: Specifies AWS as the identity provider
          - `podIdentity.identityOwner: workload`: KEDA uses the specified IAM role ARN
