...
<Tabs>
  ...
  <Tab title="KEDA (Event-Driven)">
    ...
    **AWS clusters only** - KEDA autoscaling is currently available exclusively for applications deployed on AWS.
    ...
    <Note>
    **Prerequisite**: KEDA must be enabled at the cluster level before you can use event-driven autoscaling. Contact your cluster administrator or enable KEDA in your cluster settings.
    </Note>
