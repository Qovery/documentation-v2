---
title: "Jenkins"
description: "Deploy with Jenkins and Qovery CLI"
---

Deploy your applications with Jenkins using the Qovery CLI.

## Prerequisites

Before you can deploy your application with Jenkins, you need to:
...
Since Jenkins also provides a `.yaml` file to configure your pipeline, refer to [GitLab CI](/integrations/ci-cd/gitlab-ci) and [GitHub Actions](/integrations/ci-cd/github-actions) examples to learn how to configure your pipeline with Qovery.
