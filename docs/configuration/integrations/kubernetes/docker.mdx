...
<Steps>
  ...
  <Step title="Deploy Demo Application">
    Run the following command to deploy a demo application on your local cluster:
    ...
    Once complete, you can access your application locally and explore Qovery's features.
  </Step>
</Steps>
