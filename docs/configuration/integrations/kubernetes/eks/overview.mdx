...
<CardGroup cols={2}>
  ...
  <Card title="Bring Your Own EKS (BYOK)" icon="server" href="/configuration/integrations/kubernetes/eks/byok">
    **Full Control**
...
<CardGroup cols={2}>
  ...
  <Card title="BYOK EKS Setup" icon="plug" href="/configuration/integrations/kubernetes/eks/byok">
    Connect existing EKS cluster
  </Card>

  <Card title="AWS Installation Guide" icon="book" href="/configuration/integrations/kubernetes/eks/overview">
    Detailed AWS installation guide
  </Card>

  <Card title="EKS Anywhere" icon="building" href="/configuration/integrations/kubernetes/eks-anywhere">
