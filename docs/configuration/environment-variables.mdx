...
<CardGroup cols={2}>
  ...
  <Card title="Deploy Application" href="/guides/getting-started/deploy-your-first-application">
    Deploy with configured variables
  </Card>

  <Card title="Connect Database" href="/guides/getting-started/connect-database">
