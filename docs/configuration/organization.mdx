...
<Steps>
  <Step title="Access Organization Menu">
    Click on your profile icon button on the left navbar
  </Step>
...
1. Locate the organization dropdown in the bottom left of the navbar
2. Click on the dropdown to see all available organizations
3. Select the organization you want to switch to

<Frame>
  <img src="/images/configuration/organization/change_organization.png" alt="Change organization" />
</Frame>

## Delete an Organization

<Warning>
Deleting an organization is **irreversible**. All data associated with the organization will be permanently deleted.
</Warning>
...
<Frame>
  <img src="/images/configuration/organization/access_settings.png" alt="Access organization settings" />
</Frame>
...
<Info>
Admin contact emails are used for communications about infrastructure outages, maintenance updates, and weekly and monthly usage reports.
</Info>
