...
<CardGroup cols={2}>
  <Card title="Connect Database Guide" href="/getting-started/guides/getting-started/connect-database">
  ...
  <Card title="VPC Peering" href="/configuration/integrations/aws/vpc-peering">
