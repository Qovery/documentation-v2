...
<CardGroup cols={2}>
  <Card title="AWS EKS with Karpenter" icon="/images/logos/cloud-providers/aws-icon.svg" href="/configuration/integrations/kubernetes/eks/managed">
    Create managed EKS cluster with Karpenter autoscaling
  </Card>
  <Card title="AWS EKS" icon="/images/logos/cloud-providers/aws-icon.svg" href="/configuration/integrations/kubernetes/eks/managed">
