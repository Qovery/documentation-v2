...
<CardGroup cols={2}>
  <Card title="AWS EKS with Karpenter" icon="aws" href="/integrations/kubernetes/eks/managed">
  ...
  <Card title="Scaleway Kapsule" icon="/images/logos/cloud-providers/scaleway-icon-light.svg" href="/integrations/kubernetes/scaleway/managed">
...
<CardGroup cols={2}>
  ...
  <Card title="Configure Monitoring" icon="chart-line" href="/integrations/observability/qovery-observe">
    Set up observability and monitoring
  </Card>
  <Card title="Secure Your Cluster" icon="shield-check" href="/guides/qovery-101/secure">
