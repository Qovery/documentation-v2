...
<Steps>
  ...
  <Step title="Configure in Qovery">
    ...
    3. Select **AWS Route53** as the DNS provider
    4. Enter your domain (e.g., `example.com`)
    5. Paste your AWS Access Key ID
    6. Paste your AWS Secret Access Key
    7. Enter your AWS region (e.g., `us-east-1`)
    8. Enter your Hosted Zone ID (optional, auto-detected if not provided)
    9. Save configuration
  </Step>

  <Step title="Verify DNS">
    Qovery will automatically create and manage DNS records in your Route53 hosted zone
  </Step>
</Steps>
