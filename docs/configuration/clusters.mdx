...
<Step title="Configure in Qovery">
  1. Navigate to your cluster settings 2. Find the **Custom Domain** section 3.
  Enter your domain (e.g., `example.com`) 4. Paste your Cloudflare API token 5.
  Save configuration
</Step>
...
<Info>
  This feature is currently in **Beta**. Additional DNS providers will be
