...
<CardGroup cols={3}>
  ...
  <Card title="Google GKE" icon="google" href="/configuration/integrations/kubernetes/gke/overview">
    Google Kubernetes Engine
  </Card>

  <Card title="Azure AKS" icon="microsoft" href="/configuration/integrations/kubernetes/aks/overview">
    Azure Kubernetes Service
  </Card>

  <Card title="Scaleway Kapsule" icon="server" href="/configuration/integrations/kubernetes/scaleway/overview">
    Scaleway Kubernetes Kapsule
  </Card>

  <Card title="Bring Your Own Kubernetes" icon="dharmachakra" href="/configuration/integrations/kubernetes/byok">
    Any Kubernetes cluster
  </Card>

  <Card title="Kubernetes Overview" icon="dharmachakra" href="/configuration/integrations/kubernetes/eks/overview">
...
<CardGroup cols={3}>
  <Card title="GitHub" icon="github" href="/configuration/organization/git-repository-access">
    GitHub and GitHub Enterprise
  </Card>

  <Card title="GitLab" icon="gitlab" href="/configuration/organization/git-repository-access">
    GitLab cloud and self-hosted
  </Card>

  <Card title="Bitbucket" icon="bitbucket" href="/configuration/organization/git-repository-access">
...
<CardGroup cols={3}>
  ...
  <Card title="AWS ECR" icon="aws" href="/configuration/integrations/container-registries/aws-ecr">
    Amazon Elastic Container Registry
  </Card>

  <Card title="GCP Artifact Registry" icon="google" href="/configuration/integrations/container-registries/gcp-artifact-registry">
    Google Cloud Artifact Registry
  </Card>

  <Card title="Azure ACR" icon="microsoft" href="/configuration/integrations/container-registries/azure-acr">
  ...
  <Card title="GitLab Container Registry" icon="gitlab" href="/configuration/integrations/container-registries/gitlab-cr">
    GitLab Container Registry
  </Card>

  <Card title="Scaleway Container Registry" icon="server" href="/configuration/integrations/container-registries/scaleway-cr">
...
<CardGroup cols={3}>
  ...
  <Card title="GitHub Actions Enterprise" icon="github" href="/configuration/integrations/ci-cd/github-actions">
    GitHub Enterprise self-hosted runners
  </Card>

  <Card title="GitLab CI" icon="gitlab" href="/configuration/integrations/ci-cd/gitlab-ci">
  ...
  <Card title="Jenkins" icon="jenkins" href="/configuration/integrations/ci-cd/jenkins">
    Jenkins pipelines
  </Card>
</CardGroup>
...
<CardGroup cols={3}>
  <Card title="Slack" icon="slack" href="/configuration/integrations/slack">
    Slack notifications
  </Card>
...
<CardGroup cols={2}>
  ...
  <Card title="Terraform Provider" icon="cube" href="/terraform-provider/overview">
