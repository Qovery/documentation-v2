...
**Common Use Cases**:
- [Seed databases in preview environments](/guides/others/database-seeding-lifecycle-job)
...
Duplicate a Lifecycle Job configuration to the same or different environment:
...
<CardGroup cols={2}>
  <Card title="Database Seeding Guide" icon="seedling" href="/guides/others/database-seeding-lifecycle-job">
