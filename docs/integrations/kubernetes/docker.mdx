...
<CardGroup cols={2}>
  <Card title="Deploy First App" icon="rocket" href="/guides/getting-started/deploy-your-first-application">
  ...
  <Card title="Local Installation" icon="book" href="/quickstart#deploy-now">
