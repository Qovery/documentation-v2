...
<AccordionGroup>
  ...
  <Accordion title="Helm Service Logging Limitations" icon="helm">
...
<AccordionGroup>
  ...
  <Accordion title="Missing SQS Permissions with Karpenter (AWS)" icon="aws">
    ...
    **Solution:**
    ...
    <Steps>
      <Step title="Verify IAM Policy">
        1. Check the [official Qovery IAM policy](https://hub.qovery.com/files/qovery-iam-aws.json)
      ...
      <Step title="Interpret Results">
        **Scenario 1: Permissions Allowed (with SCPs enabled)**
        ...
        - Contact Qovery Support through the [Community Forum](https://discuss.qovery.com/)
...
<CardGroup cols={3}>
  ...
  <Card title="Help & Support" icon="life-ring" href="/useful-resources/help-and-support">
